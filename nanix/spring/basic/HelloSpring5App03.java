...
import nanix.spring.beans.HelloSpring5Bean02;
import nanix.spring.beans.HelloSpring5Bean03;
import nanix.spring.beans.HelloSpring5Bean03Eng;
import nanix.spring.beans.HelloSpring5Bean03Ger;
import nanix.spring.beans.HelloSpring5Bean03Jpn;
import nanix.spring.beans.HelloSpring5Bean03Kor;
...
public class HelloSpring5App03 {
    ...
    // HelloSpring5Bean03Jpn, HelloSpring5Bean03Ger에 의존적이라는 의미
	...
	public static void main(String[] args) {
		 ...
		 //HelloSpring5Bean03Ger bean4 = new HelloSpring5Bean03Ger();
		 //bean4.sayHello("Frühling 5!");
		...
		bean = new HelloSpring5Bean03Ger();
		bean.sayHello("Frühling 5!");
