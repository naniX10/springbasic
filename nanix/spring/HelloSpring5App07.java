...
public class HelloSpring5App07 {
	...
	// 스프링에 애노테이션을 도입한 계기
    // 구글의 '밥 리'라는 사람이
    // 'xml만으로 DI를 설정하는 스프링은 즐~!' 이라고
    // 비난하고, 애노테이션 기반의 초경량 DI 프레임워크를 만듦
    ...
    // @Component : 일반적인 클래스 객체에 사용 (빈 정의시 사용)
    // @Service   : 주로 서비스 객체에 사용 (중요?!) (빈 정의시 사용)
    // @Repository : 주로 DAO 객체에 사용 (중요?!) (빈 정의시 사용)
	...
	public static void main(String[] args) {
		...
		bean = (HelloSpring5Bean03) ctx.getBean("ger");
